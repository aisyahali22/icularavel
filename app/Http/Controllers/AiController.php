...
class AiController extends Controller
{
    public function generateAiPage (Request $request)
    {
        ...
        if(empty($queryTitle))
        {
            return view('pages.ai.generated-feed-content-with-ai');
        }
        ...
        if ($response->successful()) {
            ...
            return view('pages.ai.generated-feed-content-with-ai', ['data' => $data]);
        } else {
            $error = $response->body();
            return view('pages.ai.generated-feed-content-with-ai', ['error' => $error]);
        }
    }
